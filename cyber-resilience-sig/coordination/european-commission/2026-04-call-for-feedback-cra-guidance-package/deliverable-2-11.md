...
* **Upstream coordination:** Manufacturers should verify if a vulnerability is already known upstream before filing reports to avoid overwhelming maintainers with duplicate notifications.

...
Chat items \- not yet in above

* **Audience 1:** leadership in open source and leadership in open source using SMEs that place products on the EU market.  
* **Audience 2:** the IT industry in general; and regulators by extension \- as to learn what is industry "normal"  
* **Audience 3:** Open source maintainers with an organization backing them \- commercial or non-profit  
* **Audience 4:** Open source maintainers that are working independently

...
|---|---|---|---|
| **CRA Expert Group** |  | Dirk-Willem van Gulik, Mikaël Barbero, **Tobie Langel** _(lead)_ | [Meeting notes](./cra-expert-group/) |
...
|  | Market surveillance |  |  |
||
| **CEN/CENELEC WG9** |  | **Juan Rico** _(lead)_, Lars Francke, Marta Rybczynska, Mikaël Barbero, Roman Zhukov, Timo Perala, Tobie Langel | [Meeting notes](./cen-cenelec-wg9/) |
...
||
| **ETSI CYBER-EUSR** |  | Jordan Maris, Juan Rico, Roman Zhukov, **Simon Phipps** _(lead)_, Daniel Thompson-Yvetot | [Meeting notes](./etsi-cyber-eusr/) |

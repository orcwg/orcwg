...
| ----- | ----- | :---: |
| Approval of the [minutes of the previous ORC Steering Committee call](./2026-02-12-mom-orcwg-steering-committee.md)  | Juan | 5 |
| ORC Status Update | Juan | 10 |
| CRA Expert Group | Juan | 15 |
| Cyber Security Act call for feedback ORC role | Juan | 5 |
| [Attestations joint statement](https://docs.google.com/document/d/1KOO0ZkknEE96w4iscYZh0kUdUJhE4g167KTqam3Xtqc/edit?usp=sharing) and ORC public positioning | Juan & Shanda | 15 |
| AOB | All | 5 |
...
- The discussion to define the feedback is done in the [ORCGithub](https://github.com/orcwg/orcwg/issues/252) \- there will be a sub-issue per topic reported to the shared document.  
